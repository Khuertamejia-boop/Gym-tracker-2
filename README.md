...
- **Entrenar**: la vista de tu plan con una pestaña por día (✓ en los hechos esta semana), cada ejercicio con su miniatura de músculos, series, reps y tu último peso, y el botón **Empezar**.
  ...
  - **Compartir entrenamiento** (botón protagonista del resumen, estilo Strava): imagen en formato historia 9:16 con el cuerpo y los músculos trabajados (también en texto: «Cuádriceps · Glúteos»), el volumen, el tiempo, las series y, si hubo récords, una cápsula «¡NUEVO PR!». Es un **PNG transparente** para pegar sobre tu foto en Instagram, o se pone directamente sobre una foto de tu galería con *Usar mi foto*. El bloque se **arrastra** con el dedo y se **pellizca** para cambiar el tamaño (con imán al centro); el botón redondo de la esquina cambia la alineación (izquierda, centro, derecha) y doble toque lo devuelve a su sitio. La app recuerda tu elección. Botones: Compartir, Guardar y Usar mi foto.
