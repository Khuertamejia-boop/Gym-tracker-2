...
- **Entrenar**: la vista de tu plan con una pestaña por día (✓ en los hechos esta semana), cada ejercicio con su miniatura de músculos, series, reps y tu último peso, y el botón **Empezar**.
  ...
  - **Compartir entrenamiento** (botón protagonista del resumen, estilo Strava): imagen en formato historia 9:16 con el cuerpo y los músculos trabajados (también en texto: «Cuádriceps · Glúteos»), el volumen, el tiempo, las series y, si hubo récords, una cápsula dorada «¡NUEVO PR!». Es un **PNG transparente** para pegar sobre tu foto en Instagram, o se pone directamente sobre una foto de tu galería con *Usar mi foto*. Se puede ajustar la **alineación** (izquierda, centro, derecha), el **tamaño** del texto (A pequeña, mediana, grande) y la **posición** (arriba o abajo); la app recuerda tu elección. Botones: Compartir, Guardar y Usar mi foto.
