...
- **Entrenar**: la vista de tu plan con una pestaña por día (✓ en los hechos esta semana), cada ejercicio con su miniatura de músculos, series, reps y tu último peso, y el botón **Empezar**.
  ...
  - **Compartir entrenamiento** (botón protagonista del resumen, estilo Strava): imagen en formato historia 9:16 con el cuerpo y los músculos trabajados (también en texto, los 3 con más series: «Cuádriceps · Glúteos · Femorales»), el volumen, el tiempo, las series y, si hubo récords, una cápsula «¡NUEVO PR!». Es un **PNG transparente** para pegar sobre tu foto en Instagram, o se pone directamente sobre una foto de tu galería con *Usar mi foto*. El bloque se **arrastra** con el dedo y con dos dedos se **pellizca** para cambiar el tamaño (con imán al centro) y se **gira** (con imán a la posición recta); cada **toque** cambia la alineación (izquierda → centro → derecha). Detrás del bloque va una sombra difuminada (halo) que lo acompaña para que el texto se lea sobre cualquier foto; en el PNG transparente es más leve. La app recuerda tu elección. Botones: Compartir, Guardar y Usar mi foto.
